...
let envDisable =
  isTrue(process.env.DISABLE_OPENCOLLECTIVE) || isTrue(process.env.CI);
...
\u001b[35m L7-React 全面升级为 LarkMap\u001b[32m (${'https://github.com/antvis/LarkMap'})\u001b[35m, \u001b[35mL7-React 已经停止维护! 请手动升级。
